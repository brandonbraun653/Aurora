...
/*-------------------------------------------------
Developer Note:
For now, these were taken from the AT25xxx spec b/c
I needed to get a driver working fast. Adjust this
later to be a bit more JEDEC compliant. Mostly this
file is just an architectural placeholder for now.
-------------------------------------------------*/


namespace Aurora::Flash::CFI
{
  /*-------------------------------------------------------------------------------
  General Constants
  -------------------------------------------------------------------------------*/
